...
(()=>{
    const e = new Error("Cannot find module '../../components/MatrixBackground'");
...
function MovieRecommendation() {
    ...
    const year = parseInt(searchParams.get("year")) || 1900;
    ...
    const filteredMovies = mockMovies.filter((movie)=>movie.year >= year && (!language || movie.language === language) && (!genres.length || genres.every((genre)=>movie.genres.includes(genre))));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d6182379._.js.map