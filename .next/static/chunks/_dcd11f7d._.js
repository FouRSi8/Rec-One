...
function MoviePreferenceSelector() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MoviePreferenceSelector.useEffect": ()=>{
            if (searchQuery) {
                setLoading(true);
                fetch("/api/movies?q=".concat(encodeURIComponent(searchQuery))).then({
                    "MoviePreferenceSelector.useEffect": (response)=>{
                        if (!response.ok) throw new Error("Network response was not ok");
                        return response.json();
                    }
                }["MoviePreferenceSelector.useEffect"]).then({
                    "MoviePreferenceSelector.useEffect": (data)=>{
...
//# sourceMappingURL=_dcd11f7d._.js.map